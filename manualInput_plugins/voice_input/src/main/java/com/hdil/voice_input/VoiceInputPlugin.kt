...
//        return PermissionHandler.checkAudioPermission(context)
//    }
//
//    fun requestPermission(activity: Activity, requestCode: Int) {
//        PermissionHandler.requestAudioPermission(activity, requestCode)
//    }
//
//    fun onActivate() {
//        recognizerManager.startListening(RecognitionListenerImpl(onResult = { result ->
//            viewModel.recognizedText.value = result
//            Logger.i("[$pluginId] Recognized: $result")
//        }))
//    }
//
//    fun onDeactivate() {
...
//    }
//
//    // ViewModel을 내부 클래스로 정의하여 Application 없이도 사용 가능하게 함
...
//}
//
//// VoiceInputScreen을 수정하여 Application 없는 ViewModel을 사용하게 함
//@Composable
